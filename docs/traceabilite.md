...
et sur le dépôt — six extracteurs, **428 tests**, **46 décisions**,
**20 dossiers d'incident**, **23 réserves**. Les écarts du premier relevé sont repris en fin de
...
| C16 | Démarche de gestion de projet | **présent** | Démarche **réellement suivie**, mesurée dans l'historique : 474 commits en deux phases séparées de treize mois, découpage par chantier plutôt que par sprint, 20 branches, 118 des 120 commits récents portant leur compétence, 46 décisions, 6 notes de session. Ce qui manque est énoncé — ni rétrospective formalisée, ni estimation, ni revue par un pair — avec le coût réel de chaque manque | `docs/demarche_projet.md` |
